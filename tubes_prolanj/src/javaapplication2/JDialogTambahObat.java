 ...
 * @author EGIW
 */
public class JDialogTambahObat extends javax.swing.JDialog {
     ...
     */
    public JDialogTambahObat(DB db, TampilData parent, boolean modal) {
        super(parent, modal);
        this.db = db;
        this.parent = parent;
        initComponents();
    ...
    public void clearForm() {
        try {
            int nextId = db.getLastId() + 1;
            System.out.println(String.valueOf(nextId));
            jTfKode.setText(String.valueOf(nextId));
        } catch (SQLException ex) {
            Logger.getLogger(JDialogTambahObat.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jBtnSimpanClickSimpan(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnSimpanClickSimpan
        try {
            ...
            db.tambahObat(namaObat, hargaBeli, hargaJual, satuan, stok);
        ...
        clearForm();
    }//GEN-LAST:event_jBtnSimpanClickSimpan
